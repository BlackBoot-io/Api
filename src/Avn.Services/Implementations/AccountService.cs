...
public class AccountService : IAccountService
{
    ...
    public async Task<IActionResponse<UserTokenDto>> SignupAsync(User user, CancellationToken cancellationToken = default)
    {
        ...
        #region send code
        await _emailGatewayAdapter.Send(new EmailRequestDto(VerificationType.Verification, user.Email, "Recovery Password", newCode));
        #endregion
    ...
    public async Task<IActionResponse<bool>> ResendOtpAsync(Guid userId, CancellationToken cancellationToken = default)
    {
        ...
        await _emailGatewayAdapter.Send(new EmailRequestDto(VerificationType.Verification, foundUser.Email, "Recovery Password", newCode));
